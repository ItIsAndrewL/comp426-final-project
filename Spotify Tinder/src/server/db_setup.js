...
await db.run('CREATE TABLE IF NOT EXISTS Favorites (id INTEGER PRIMARY KEY, user_id INTEGER NOT NULL, song_id varchar(256) NOT NULL, FOREIGN KEY (userKey) REFERENCES Users(id)');
